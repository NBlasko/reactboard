...
class Signup extends Component {
    ...
    varifyEmail() {
        ...
        axios.post(SERVERURL + 'api/auth/verify-mail', { email, accessCode })
            .then((response) => {
    ...
    resendVerifyEmail() {
        ...
        axios.post(SERVERURL + 'api/auth/resend-verification-mail', { email })
            .then((response) => {
    ...
    signUp() {
        ...
        axios.post(SERVERURL + 'api/auth/signup', { email, password, displayName })
            .then((response) => {
                    ...
                    <Row>
                        ...
                        <Col lg="6" md="8" sm="10" xs="12">
                            <Form className="form-boxshadow p-3 rounded">
                                ...
                                <FormGroup> <Input type="text" placeholder="name" name="displayName" onChange={this.handleChange} onKeyPress={this.handleKeyPress} /> </FormGroup>
