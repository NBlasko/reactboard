...
import { Button, Form, FormGroup, Input, Container, Alert, Row, Col, Modal, ModalHeader, ModalBody, ModalFooter } from "reactstrap";
      ...
      .catch(error => {
        if (error.response.data.error.includes("accessCode"))
          return this.setState({
            errorMessage: "verification code length must be 5 characters long"
          });
        this.setState({ errorMessage: error.response.data.error, blockUnmounting: false });
      });
  }
      ...
      <div>
            ...
            <Col lg="6" md="8" sm="10" xs="12">
              <Form className="form-boxshadow p-3 rounded">
                ...
                <FormGroup>
                  ...
                  <span className="hoverSocial">
                    <GoogleLogin
                      clientId="598369716678-bv03jnf46d6r6ie1sc4nan0k3ja975jv.apps.googleusercontent.com"
                ...
                <FormGroup>
                  {" "}
                  <Input type="email" placeholder="email" name="email" onChange={this.handleChange} onKeyPress={this.handleKeyPress} />{" "}
                </FormGroup>
                <FormGroup>
                  {" "}
                  <Input
                ...
                <FormGroup>
                  {" "}
                  <Button color="primary" className="rigthAlign" type="button" onClick={this.signIn}>
                    {" "}
                    Sign In{" "}
                  </Button>{" "}
                </FormGroup>
        ...
        <Modal isOpen={this.state.modal} toggle={this.toggle} className={this.props.className}>
          ...
          <ModalBody>
            ...
            <div>
              {" "}
              <Input type="text" placeholder="verification code" name="accessCode" onChange={this.handleChange} />{" "}
            </div>
          ...
          <ModalFooter>
            ...
            <Button color="secondary" onClick={this.resendVerifyEmail}>
              Resend email
            </Button>
          </ModalFooter>
        </Modal>
