...
export const getCommentsAction = (blogID, skip) => (dispatch) => {
  axios({
    ...
    url: SERVER_BASE_URL + "api/blogs/" + blogID + "/comments?skip=" + skip,
  })
    .then((res) => {
      dispatch({
        type: GET_COMMENTS,
...
export const addCommentAction =
  ({ author, text, blogsID, authorsPublicID }) =>
  (dispatch) => {
    axios({
      method: "POST",
      headers: {
...
export const addBlogsLikeAction =
  ({ like, blogsID }) =>
  (dispatch) => {
    axios({
      method: "POST",
...
export const getProfileMessagesAction = (skip, authorsPublicID) => (dispatch) => {
  axios({
    ...
    url: SERVER_BASE_URL + "api/profiles?skip=" + skip + "&authorsPublicID=" + authorsPublicID,
  })
    .then((res) => {
      dispatch({
        type: GET_MESSAGES,
...
export const addProfileTrustAction =
  ({ trust, blogsID }) =>
  (dispatch) => {
    axios({
      method: "POST",
